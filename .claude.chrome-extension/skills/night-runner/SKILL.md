---
name: night-runner
description: Autonomous development mode for Chrome Extension. After blueprints are defined, builds the entire extension without human review. Self-reviews, self-corrects, and escalates only when stuck.
...
# Night-Runner: Autonomous Development (Chrome Extension)
