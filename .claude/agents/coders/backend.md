...
|------|-------------|--------|
| `instruction_unclear` | Missing input/output definition | Report back to instructor |
| `technical_error` | PHP syntax issue | Include error message |
| `dependency_missing` | Required model/service not found | Suggest blocked_by |
